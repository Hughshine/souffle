...
Design proposals and optimization ideas that are not fully implemented.
...
- Canonical status labels are maintained in `docs/INDEX.md`.
...
- [docs/design/README.scbf.formula.md](docs/design/README.scbf.formula.md)
- [docs/design/README.scbf.global-formula.md](docs/design/README.scbf.global-formula.md)
