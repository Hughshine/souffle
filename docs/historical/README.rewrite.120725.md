...
## Background / Usage
- Core code: `src/include/souffle/problog/GraphAnalyzer.h` (SISO detection), `GraphRewriter.h` (rewrite and post-processing), `Pipeline.h` (pipeline timing), `docs/historical/Plan.md` tracks TODOs.
