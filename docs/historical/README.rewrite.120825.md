...
- Use `docs/topics/rewrite/README.rewrite.impl.md` for current behavior and `docs/topics/evaluation/README.eval.md` for runs.
...
- Core components: `src/include/souffle/problog/GraphAnalyzer.h` (SISO detection), `GraphRewriter.h` (rewrite and edge compaction), `Pipeline.h` (pipeline timing), `docs/historical/Plan.md` (task log).
