...
- Eqrel-style merging (`docs/design/README.eqrel.md`) becomes a secondary cleanup, not a primary fix.
...
- Full per-case timing table (including `rand_vars`) is recorded in
  `docs/topics/evaluation/README.eval.md` and `docs/topics/rewrite/README.rewrite.impl.md`.
