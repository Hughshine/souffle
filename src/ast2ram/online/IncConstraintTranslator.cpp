...
/************************************************************************
 *
 * @file IncConstraintTranslator.cpp
 *
 ***********************************************************************/
...
Own<ram::Condition> IncConstraintTranslator::translateConstraint(const ast::Literal* lit) {
    assert(lit != nullptr && "literal should be defined");
    return IncConstraintTranslator(context, index)(*lit);
}

Own<ram::Condition> IncConstraintTranslator::visit_(type_identity<ast::Atom>, const ast::Atom&) {
    return nullptr;  // covered already within the scan/lookup generation step
}

Own<ram::Condition> IncConstraintTranslator::visit_(
...
Own<ram::Condition> IncConstraintTranslator::visit_(type_identity<ast::Negation>, const ast::Negation& neg) {
