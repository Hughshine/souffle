...
std::vector<MainOption> getMainOptions() {
  ...
  std::vector<MainOption> options{
      ...
      {"inc-reorder-policy", nextOptChar++, incReorderPolicyOptionSyntax(), "pressure", false,
          "Incremental CUDD reordering policy."},
      {"inc-reorder-auto-gap", nextOptChar++, "N", "0", false,
          "Incremental CUDD auto-reorder next-threshold gap."},
      {"inc-reorder-work-threshold", nextOptChar++, "N", "2500", false,
          "Incremental BDD-pressure reorder threshold."},
      {"inc-reorder-count-dead", nextOptChar++, "", "", false,
          "Count dead CUDD nodes when triggering incremental auto reorder."},
      {"inc-reorder-allow-large", nextOptChar++, "", "", false,
          "Allow incremental auto reorder on managers with at least 3M live nodes."},
